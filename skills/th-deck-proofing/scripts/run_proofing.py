...
def main() -> int:
    parser = argparse.ArgumentParser(description="Wrapper for deck proofing analysis.")
    ...
    command = ["python", "scripts/analyze/deck_proofing.py", "--pack-dir", args.pack_dir]
    if args.prior_pack_dir:
        command.extend(["--prior-pack-dir", args.prior_pack_dir])
